...
@Sharable
public class AgentDispatchInboundHandler extends ChannelInboundHandlerAdapter {
	//
	private static final Logger logger = LoggerFactory.getLogger(AgentDispatchInboundHandler.class);
	
	private String message; 
	
	public AgentDispatchInboundHandler(String message) {
		// 
