...
public class AgentDispatchFutureListener implements ChannelFutureListener {
	//
	private static final Logger logger = LoggerFactory.getLogger(AgentDispatchFutureListener.class);
	
	public AgentDispatchFutureListener() {
		// 
	}
